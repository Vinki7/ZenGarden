...
POPULATION_SIZE = 300 # for now 300 is the best performing
MAX_GENERATIONS = 2000
MUTATION_RATE = 0.7 # for now 0.5 is the best performing or eventually 7
...
STALL_THRESHOLD = 50 # number of generations with unchanged maximum fitness
REFRESH_PERCENTAGE = 0.30
